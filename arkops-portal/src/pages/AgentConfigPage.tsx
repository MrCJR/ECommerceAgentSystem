    ...
    <div className="page-stack">
      ...
      {isAdsOptimizer && (
        <Card title={<><ThunderboltOutlined /> {t('agent.builtinTasks')}</>} style={{ marginBottom: 16 }}>
          <Row gutter={[16, 16]}>
            <Col xs={24} md={8}>
              <Card size="small" hoverable className="agent-task-card-clickable" onClick={() => setAdDashboardOpen(true)}>
                <Typography.Text strong style={{ fontSize: 13 }}>
        ...
        <Card title={<><GiftOutlined /> {t('agent.builtinTasks')}</>} style={{ marginBottom: 16 }}>
          <Row gutter={[16, 16]}>
            <Col xs={24} sm={12} md={6}>
              <Card size="small" hoverable className="agent-task-card-clickable" onClick={() => setCrmModalOpen(true)}>
                <Typography.Text strong style={{ fontSize: 13 }}>
      ...
      {isReviewManager && (
        <Card title={<><StarOutlined /> {t('agent.builtinTasks')}</>} style={{ marginBottom: 16 }}>
          <Row gutter={[16, 16]}>
            <Col xs={24} md={8}>
              <Card size="small" hoverable className="agent-task-card-clickable" onClick={() => setReviewModalOpen(true)}>
                <Typography.Text strong style={{ fontSize: 13 }}>
      ...
      {isCustomerService && (
        <Card title={<><CustomerServiceOutlined /> {t('agent.builtinTasks')}</>} style={{ marginBottom: 16 }}>
          <Row gutter={[16, 16]}>
            <Col xs={24} md={8}>
              <Card size="small" hoverable className="agent-task-card-clickable" onClick={() => setCsModalOpen(true)}>
                <Typography.Text strong style={{ fontSize: 13 }}>
      ...
      {isCreativeFactory && (
        <Card title={<><PictureOutlined /> {t('agent.builtinTasks')}</>} style={{ marginBottom: 16 }}>
          <Row gutter={[16, 16]}>
            <Col xs={24} md={8}>
              <Card hoverable size="small" className="agent-task-card-clickable" onClick={() => setCreativeModalOpen(true)}>
                <Typography.Text strong style={{ fontSize: 13 }}>
      ...
      {isRiskControl && (
        <Card title={<><SafetyOutlined /> {t('agent.builtinTasks')}</>} style={{ marginBottom: 16 }}>
          <Row gutter={[16, 16]}>
            <Col xs={24} md={8}>
              <Card hoverable size="small" className="agent-task-card-clickable" onClick={() => setRiskModalOpen(true)}>
                <Typography.Text strong style={{ fontSize: 13 }}>
                  <FileSearchOutlined style={{ color: '#2563eb', marginRight: 6 }} />
      ...
      {isLiveStreamOps && (
        <Card title={<><CustomerServiceOutlined /> {t('agent.builtinTasks')}</>} style={{ marginBottom: 16 }}>
          <Row gutter={[16, 16]}>
            <Col xs={24} md={8}>
              <Card hoverable size="small" className="agent-task-card-clickable" onClick={() => setLiveModalOpen(true)}>
                <Typography.Text strong style={{ fontSize: 13 }}>
