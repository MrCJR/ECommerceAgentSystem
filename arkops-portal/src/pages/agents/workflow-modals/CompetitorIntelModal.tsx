...
const trendConfig = {
  rising: { color: '#16a34a', icon: <RiseOutlined />, tag: '' },
  stable: { color: '#64748b', icon: <MinusOutlined />, tag: '' },
  declining: { color: '#dc2626', icon: <ArrowDownOutlined />, tag: '' },
};

export function CompetitorIntelModal({ open, onClose }: CompetitorIntelModalProps) {
  const { t } = useI18n();
